window.UFOBullet = function (player, fromBody, fromOffset, pos, angle) {
  this.player = player;
  this.radius = 0.25;
  ...
  this.body._IsUFOBullet = true;

  this.life = 3;

  sounds['audio/ufo_gun.wav'].volume = 0.25;
  sounds['audio/ufo_gun.wav'].playbackRate = 1;
  sounds['audio/ufo_gun.wav'].play();
};

UFOBullet.prototype.updateRender = function (dt, time, ctx) {
  ...
  if (this.body._UFOBulletDestroyed) {
    this.life = 0;
  }
...
UFOBullet.prototype.onRemove = function () {
