...
window.GroundObject = function (lcoordinate, rcoordinate) {
  ...
  this.mesh2 = new THREE.Mesh(new THREE.PlaneBufferGeometry(10 * BT_SIZE, 10 * BT_SIZE), this.mat2);
  this.mesh2.position.set(0., (GROUND_LEVEL - 2) * BT_SIZE - 20 - BT_SIZE * 3, 2);
  ...
  this.mesh3 = new THREE.Mesh(new THREE.PlaneBufferGeometry(9 * BT_SIZE, 9 * BT_SIZE), this.mat3);
  this.mesh3.position.set(0., (GROUND_LEVEL - 2) * BT_SIZE - 20 + BT_SIZE * 0.5, -1.5);
...
GroundObject.prototype.updateRender = function (dt, time, ctx) {
  this.mesh3.position.set(0., (GROUND_LEVEL - 2) * BT_SIZE - 20 + BT_SIZE * 0.5 + Math.sin(time*Math.PI*0.25)* BT_SIZE*0.1, -1.5);
  return true;
};
